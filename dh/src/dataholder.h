...
namespace ch
{
	...
	protected:
		...
		size_t coordPad;	///<	padding between coordinates in bytes
		size_t diffSize;	///<	difference between begin address of two consecutive vertices in bytes
		size_t vertNum;		///<	number of vertices
	};
}
